...
// Only apply Artifactory configuration when explicitly publishing
// Usage: ./gradlew artifactoryPublish -PPUBLISH_TO_ARTIFACTORY=true
val enableArtifactory = project.hasProperty("PUBLISH_TO_ARTIFACTORY")
