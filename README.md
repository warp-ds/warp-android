...
```gradle
implementation("com.schibsted.nmp.warp:warp-android:0.0.9")

finnImplementation("com.schibsted.nmp.warp:warp-android-finn:0.0.10")

toriImplementation("com.schibsted.nmp.warp:warp-android-tori:0.0.11")
```
