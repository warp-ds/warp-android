...
```gradle
implementation("com.schibsted.nmp.warp:warp-android:0.0.22")

finnImplementation("com.schibsted.nmp.warp:warp-android-finn:0.0.22")

toriImplementation("com.schibsted.nmp.warp:warp-android-tori:0.0.22")
```
